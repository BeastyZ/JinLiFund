...
<body class="text-center">
	<form class="form-signin">
		<img class="mb-4" src="images/web_logo.png" alt=""
			width="72" height="72">
		<h1 class="h3 mb-3 font-weight-normal">欢迎登录</h1>
		<label for="inputEmail" class="sr-only">账号</label> <input
		...
		<p class="mt-5 mb-3 text-muted">&copy;2020.10-2020.12 &nbsp; 锦鲤金服有限公司 </p>
	</form>
